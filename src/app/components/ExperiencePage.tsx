        ...
        <section className="rounded-lg p-4 sm:p-8 max-w-4xl w-full grid place-items-center">
          <div className="grid grid-cols-1 gap-7 w-full md:w-96 lg:w-128">
            <div className="flex flex-col items-center">
              <div className="relative experience-card flex flex-col justify-between border rounded-lg shadow-xl bg-gray-900 dark:bg-gray-900 z-10 mx-4 p-4 sm:p-6 min-w-full md:min-w-96 lg:min-w-128 overflow-y-auto max-h-96">
